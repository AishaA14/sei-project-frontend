<template>
    <div>
      ...
      <!-- find a way to make the inputs for appearance and type a drop down menu -->
      <div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        fruitData: {
          name: '',
          type: 'Paramecia', // Set a default value for type
          character: '',
          firstAppearance: '',
          abilities: ''
        },
    ...
    methods: {
      async addNewFruit() {
        this.error = ''
        this.success = ''
        // Fetch the user ID from the database during user authentication
        let userId = '' // Initialize user ID

       // Implement user authentication logic here and set userId based on the authenticated user
       ...
       // If user authentication is successful, proceed to add the fruit
       const requestData = {
